...
//  StockPortforlio
//
//  Created by Bo Warren on 11/14/20.
//  Copyright © 2020 rpwarren. All rights reserved.
//

import UIKit

class IndexViewController: UIViewController, StockDelegate {
    ...
    @objc func searchButtonPressed() {
        ...
        let destinationVC = storyboard?.instantiateViewController(identifier: "SearchVC") as! SearchViewController
